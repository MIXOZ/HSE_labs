...
namespace Huffman {
    ...
    HuffmanTree::HuffmanTree(const std::map<char, int> &frequency_table) {
        auto comp = [](const std::pair<int, std::shared_ptr<HuffmanNode>> &o1,
                       const std::pair<int, std::shared_ptr<HuffmanNode>> &o2) -> bool {
    ...
    HuffmanNode::HuffmanNode(char _value, std::shared_ptr<HuffmanNode> lt, std::shared_ptr<HuffmanNode> rt,
                             std::shared_ptr<HuffmanNode> pt) :
